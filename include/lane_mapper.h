...
class LaneMapper {
 ...
 private:
  ...
  void init_map(const FrameObservation &frame_observation, const Odometry &pose);
  void track_with_last_frame(const FrameObservation &frame_observation, const Odometry &pose);
  void track_with_map(const FrameObservation &frame_observation, const Odometry &pose);
  void optimize();
